 ...
 * 
 */
class Exponential : public FlowHandlePointer{
     ...
     */
    Exponential(const string name="teste", System* input = NULL, System* output = NULL) : FlowHandlePointer(name, input, output, 0.0) {}
    /**
    ...
    virtual double execute(){
        return 0.01 * getSystemInput()->getValue();
    }
};
 ...
 * 
 */
class Logistic : public FlowHandlePointer{
    public:
    /**
     ...
     */
    Logistic(const string name="teste", System* input = NULL, System* output = NULL) : FlowHandlePointer(name, input, output,0.0) {}
    /**
     ...
     */
    virtual double execute(){
        return 0.01 * getSystemOutput()->getValue() * (1-(getSystemOutput()->getValue()/70));
    }
};
 ...
 * 
 */
class ComplexFlow : public FlowHandlePointer{
    public:
    /**
     ...
     */
    ComplexFlow(const string name="teste", System* input = NULL, System* output = NULL) : FlowHandlePointer(name, input, output,0.0) {}
    /**
     * @brief extended execution function
     * 
     * @return double value of the extended execution function 
