...
void unit_System_constructor(void) {
    System *s1 = new SystemHandlePointer();
    assert(s1->getName() == "NoName");
    assert(s1->getValue() == 0.0);

    System *s2 = new SystemHandlePointer("TestName", 100.0);
...
void unit_System_getName(void) {
    System *s1 = new SystemHandlePointer("TestName", 0.0);
...
void unit_System_getValue(void) {
    System *s1 = new SystemHandlePointer("TestName", 10.0);
